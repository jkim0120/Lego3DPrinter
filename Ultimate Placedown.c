...
void moveTo (int xUnit, int yUnit)
{
	...
	motor[motorA] = 25; //changed from 20
	while (nMotorEncoder[motorA] < convUnit(1,2)*yUnit){}
	motor[motorA] = 0;
	wait10Msec(20);

	motor[motorB] = 25; //changed from 20
...
void putBlock (int xUnit, int yUnit, int layer, byte orientation)
{
	...
	motor[motorB] = 0;
	motor[motorC] = 25;
	while (nMotorEncoder[motorC] < 1220-layer*290){}
	motor[motorC] = 0;
	motor[motorA] = 10;
	wait10Msec(30);
	motor[motorA] = 0;
	...
	motor[motorB] = 0;
	motor[motorC] = 25;
	while (nMotorEncoder[motorC] < 1275-layer*290){}
	motor[motorC] = 0;
	adjust();
	motor[motorC] = 25;
	while (nMotorEncoder[motorC] < 1400-layer*290){}
	motor[motorC] = 0;
	dislodge();
	calibrate();
	if (orientation == 0x00)
